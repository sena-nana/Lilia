...
pub struct DesktopEquivalenceComposerFact {
    ...
    pub permission: crate::DesktopExecutionPermission,
    pub plan_mode: bool,
    pub goal_mode: bool,
}
        ...
        for source in self.hooks_overview(None)?.sources {
            ...
            hook_sources.push(DesktopEquivalenceHookSourceFact {
                scope: match source.scope {
                    crate::DesktopHookScope::User => "user",
                    crate::DesktopHookScope::Project => "project",
                }
                .to_owned(),
...
mod tests {
    ...
    fn snapshot_is_fixture_scoped_deterministic_and_secret_free() {
        ...
        application
            ...
            .unwrap();
        application
            .create_skill_package(crate::DesktopSkillCreate {
                expected_registry_revision: 0,
                scope: crate::DesktopSkillScope::User,
                project_cwd: None,
        ...
        application
            ...
            .unwrap();
        application
            .create_hook_source(crate::DesktopHookScope::User, None)
            .unwrap();
        application
            .update_hook_source(
                crate::DesktopHookScope::User,
                None,
                crate::DesktopHookDocumentUpdate {
                    expected_revision: 1,
                    handlers: vec![crate::DesktopHookHandlerUpdate {
