...
use crate::application::{PaneId, PanelId, PanelLayoutSnapshot, SplitAxis, WorkspaceItem, WorkspaceItemId};
...
pub struct DesktopCommandOutcome {
    pub changed: bool,
    pub workspace: crate::application::DesktopWorkspaceSnapshot,
}
