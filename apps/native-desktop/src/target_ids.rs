...
pub const PROJECT_ARCHIVE_CONVERSATIONS: &str = "native-preview.project.archive-conversations";
pub const PROJECT_ARCHIVE_DIALOG: &str = "native-preview.project.archive-conversations.dialog";
pub const PROJECT_ARCHIVE_CONFIRM: &str = "native-preview.project.archive-conversations.confirm";
pub const PROJECT_ARCHIVE_CANCEL: &str = "native-preview.project.archive-conversations.cancel";
