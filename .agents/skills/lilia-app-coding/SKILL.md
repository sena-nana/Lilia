...
- Layout composition uses `apps/desktop/src/runtime_layout.rs` (`HostStack` presets, `reconcile_children`, shared control builders such as `composer_send_button`, `pill_button`).
